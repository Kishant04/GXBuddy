...
abstract final class Endpoints {
  ...
  /// GET (Bearer) — discover current user's squad
  static const String squadMy = '/api/squad/my';

  /// GET /api/squad/by-user/{user_id}
  static String squadByUser(String userId) => '/api/squad/by-user/$userId';
  ...
  // ── Demo ──────────────────────────────────────────────────
  /// POST {user_id?} — resets account to baseline demo state
  static const String demoReset = '/api/demo/reset';
