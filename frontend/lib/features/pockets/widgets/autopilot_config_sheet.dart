        ...
        child: Column(
          ...
          children: [
            ...
            _Section(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Slider(
                    value: rule.threshold.clamp(200, 3000),
                    min: 200,
                    max: 3000,
                    divisions: 28,
            ...
            GXButton(
              label: 'Save rule',
              onPressed: () async {
                final config = AutopilotConfig(
                  salaryThreshold: rule.threshold,
                  incomeType: rule.incomeType,
                );
                await ref.read(autopilotProvider.notifier).saveConfig(config);
