...
class DashboardModel {
  ...
  factory DashboardModel.fromJson(Map<String, dynamic> json) {
    final mascotJson = json['mascot'] as Map<String, dynamic>?;
    final weeklyBudgetUsedPercent =
        (json['weekly_budget_used_percent'] as num?)?.toDouble() ?? 0.0;

    final mascot = mascotJson != null
        ? MascotModel.fromJson(mascotJson)
        : MascotModel(
            state: MascotStateX.fromPercentage(weeklyBudgetUsedPercent),
            moodLine: '',
          );
    ...
    return DashboardModel(
      ...
      weeklyBudgetUsedPercent: weeklyBudgetUsedPercent,
