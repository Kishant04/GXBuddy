...
abstract final class CurrencyFormatter {
  static final _fmt = NumberFormat.currency(locale: 'ms_MY', symbol: 'RM', decimalDigits: 2);
  static final _compact = NumberFormat.compactCurrency(locale: 'ms_MY', symbol: 'RM', decimalDigits: 1);
